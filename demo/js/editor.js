...
;function wh() {
  var a = new X(null, 1, 5, Y, [xh], null);
  return mg(function() {
...
function Ah(a) {
  ...
  b = K(b) ? b : null;
  return r(b) ? yh(oc.e ? oc.e(a) : oc.call(null, a)) : null;
}
function xh() {
  return function(a) {
    return function() {
      return new X(null, 3, 5, Y, [Qf, new X(null, 2, 5, Y, [Ef, "Live Markdown Editor"], null), new X(null, 2, 5, Y, [Kf, new X(null, 3, 5, Y, [Uf, new X(null, 3, 5, Y, [Df, new X(null, 2, 5, Y, [dg, "Editor"], null), new X(null, 2, 5, Y, [zh, a], null)], null), new X(null, 3, 5, Y, [Df, new X(null, 2, 5, Y, [dg, "Preview"], null), new X(null, 2, 5, Y, [Ah, a], null)], null)], null)], null)], null);
    };
  }(wg.e(null));
}
